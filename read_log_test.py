...
enroll_train = pd.read_csv('../data/test/enrollment_test.csv', header=False)
...
log_transform.azureml_main_count(merged1).to_csv('feature/log_feature_test.csv', index=False)
