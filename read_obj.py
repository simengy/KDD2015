...
merged = pd.merge(log_train, obj_train[['module_id','category']], left_on='object', right_on='module_id')

print merged.columns, merged.shape

obj_transform.transform(merged).to_csv('feature/obj_feature.csv', index=True)
